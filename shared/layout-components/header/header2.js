            ...
            >
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                alt=""
                                className="drop-img cover-image"
                                src={"../../../assets/img/ecommerce/02.jpg"}
                              />
                              <div className="ms-3 text-start">
                                <h5 className="mb-1 text-muted tx-13">
                                  White Ear Buds
                            ...
                            >
                              ...
                              <img
                                alt=""
                                className="drop-img cover-image"
                                src={"../../../assets/img/ecommerce/12.jpg"}
                              />
                              <div className="ms-3 text-start">
                                <h5 className="mb-1 text-muted tx-13">
                ...
                <Dropdown className=" main-profile-menu nav nav-item nav-link ps-lg-2">
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item className="dropdown-item" href={`/components/pages/mail/chat/`}>
                    ...
                    <Dropdown.Item className="dropdown-item" href={`/components/pages/mail/mail/`}>
