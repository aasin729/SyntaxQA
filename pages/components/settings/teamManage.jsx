    ...
    <div>
      ...
      <Card>
        <Card.Body className="p-0">
          ...
          <div className="d-flex justify-content-between align-items-center mt-3">
            ...
            <div className="d-block d-sm-flex align-items-center gap-2 ms-auto">
              <span className="me-3">
      ...
      <Card className="mt-5">
        <Card.Body>
          ...
          <div className="mb-4">
            {/* 관리자 */}
            <Card className="mb-2 border border-primary-subtle">
              <Card.Body className="pb-2 pt-3">
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    <div className="fw-bold mb-1"><i className="fe fe-shield me-1"/> 관리자</div>
                    <div className="text-muted small mb-2">모든 기능에 대한 전체 접근 권한을 가집니다.</div>
                    <div className="d-flex flex-wrap gap-3 mb-2">
                      <Form.Check type="checkbox" label="팀원 관리" className="me-3"
                        checked={adminPermissions.teamManage}
                        onChange={() => setAdminPermissions(prev => ({ ...prev, teamManage: !prev.teamManage }))}
                      />
                      <Form.Check type="checkbox" label="팀 설정 변경" className="me-3"
                        checked={adminPermissions.teamSetting}
                        onChange={() => setAdminPermissions(prev => ({ ...prev, teamSetting: !prev.teamSetting }))}
                      />
                      <Form.Check type="checkbox" label="권한 설정" className="me-3"
                        checked={adminPermissions.permissionSetting}
                        onChange={() => setAdminPermissions(prev => ({ ...prev, permissionSetting: !prev.permissionSetting }))}
                      />
                      <Form.Check type="checkbox" label="프로젝트 관리" className="me-3"
                        checked={adminPermissions.projectManage}
                        onChange={() => setAdminPermissions(prev => ({ ...prev, projectManage: !prev.projectManage }))}
                      />
                    </div>
                  </div>
                  <div>
            ...
            {/* 매니저 */}
            <Card className="mb-2 border border-success-subtle">
              <Card.Body className="pb-2 pt-3">
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    <div className="fw-bold  mb-1"><i className="fe fe-user-check me-1"/> 매니저</div>
                    <div className="text-muted small mb-2">대부분의 기능에 접근할 수 있으나 일부 제한이 있습니다.</div>
                    <div className="d-flex flex-wrap gap-3 mb-2">
                      <Form.Check type="checkbox" label="팀원 관리" className="me-3"
                        checked={managerPermissions.teamManage}
                        onChange={() => setManagerPermissions(prev => ({ ...prev, teamManage: !prev.teamManage }))}
                      />
                      <Form.Check type="checkbox" label="팀 설정 변경" className="me-3"
                        checked={managerPermissions.teamSetting}
                        onChange={() => setManagerPermissions(prev => ({ ...prev, teamSetting: !prev.teamSetting }))}
                      />
                      <Form.Check type="checkbox" label="권한 설정" className="me-3"
                        checked={managerPermissions.permissionSetting}
                        onChange={() => setManagerPermissions(prev => ({ ...prev, permissionSetting: !prev.permissionSetting }))}
                      />
                      <Form.Check type="checkbox" label="프로젝트 관리" className="me-3"
                        checked={managerPermissions.projectManage}
                        onChange={() => setManagerPermissions(prev => ({ ...prev, projectManage: !prev.projectManage }))}
                      />
                    </div>
                  </div>
                  <div>
            ...
            {/* 멤버 */}
            <Card className="mb-2 border border-info-subtle">
              <Card.Body className="pb-2 pt-3">
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    <div className="fw-bold  mb-1"><i className="fe fe-users me-1"/> 멤버</div>
                    <div className="text-muted small mb-2">프로젝트 작업에 필요한 기본 기능에만 접근할 수 있습니다.</div>
                    <div className="d-flex flex-wrap gap-3 mb-2">
                      <Form.Check type="checkbox" label="팀원 관리" className="me-3"
                        checked={memberPermissions.teamManage}
                        onChange={() => setMemberPermissions(prev => ({ ...prev, teamManage: !prev.teamManage }))}
                      />
                      <Form.Check type="checkbox" label="팀 설정 변경" className="me-3"
                        checked={memberPermissions.teamSetting}
                        onChange={() => setMemberPermissions(prev => ({ ...prev, teamSetting: !prev.teamSetting }))}
                      />
                      <Form.Check type="checkbox" label="권한 설정" className="me-3"
                        checked={memberPermissions.permissionSetting}
                        onChange={() => setMemberPermissions(prev => ({ ...prev, permissionSetting: !prev.permissionSetting }))}
                      />
                      <Form.Check type="checkbox" label="프로젝트 관리" className="me-3"
                        checked={memberPermissions.projectManage}
                        onChange={() => setMemberPermissions(prev => ({ ...prev, projectManage: !prev.projectManage }))}
                      />
                    </div>
                  </div>
                  <div>
            ...
            {/* 뷰어 */}
            <Card className="mb-2 border border-warning-subtle">
              <Card.Body className="pb-2 pt-3">
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    <div className="fw-bold mb-1"><i className="fe fe-eye me-1"/> 뷰어</div>
                    <div className="text-muted small mb-2">읽기 전용 접근 권한만 가집니다.</div>
                    <div className="d-flex flex-wrap gap-3 mb-2">
                      <Form.Check type="checkbox" label="팀원 관리" className="me-3"
                        checked={viewerPermissions.teamManage}
                        onChange={() => setViewerPermissions(prev => ({ ...prev, teamManage: !prev.teamManage }))}
                      />
                      <Form.Check type="checkbox" label="팀 설정 변경" className="me-3"
                        checked={viewerPermissions.teamSetting}
                        onChange={() => setViewerPermissions(prev => ({ ...prev, teamSetting: !prev.teamSetting }))}
                      />
                      <Form.Check type="checkbox" label="권한 설정" className="me-3"
                        checked={viewerPermissions.permissionSetting}
                        onChange={() => setViewerPermissions(prev => ({ ...prev, permissionSetting: !prev.permissionSetting }))}
                      />
                      <Form.Check type="checkbox" label="프로젝트 관리" className="me-3"
                        checked={viewerPermissions.projectManage}
                        onChange={() => setViewerPermissions(prev => ({ ...prev, projectManage: !prev.projectManage }))}
                      />
                    </div>
                  </div>
                  <div>
