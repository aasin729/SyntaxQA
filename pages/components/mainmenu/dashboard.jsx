...
import {Breadcrumb,Col,Row,Card,Button,ProgressBar, Form, Table, Badge} from "react-bootstrap";
...
const recentCases = [
  { status: "통과", name: "회원가입 유효성 검사", feature: "회원 관리", owner: "정현우", date: "2025-06-17", priority: "높음" },
  { status: "실패", name: "결제 프로세스 테스트", feature: "결제 시스템", owner: "송지은", date: "2025-06-18", priority: "높음" },
  { status: "통과", name: "상품 검색 필터링", feature: "상품 관리", owner: "민지훈", date: "2025-06-16", priority: "중간" },
];
...
const barOptions = {
  ...
  colors: ['#60a5fa', '#fbbf24', '#22c55e', '#ef4444'], // 파랑, 노랑, 연두, 주황
  legend: {
    position: 'bottom',
    fontSize: '13px',
    fontWeight: 500,
...
const lineOptions = {
  ...
  colors: ['#60a5fa', '#22c55e', '#ef4444'], // 파랑, 연두, 주황
  legend: {
    position: 'bottom',
    fontSize: '13px',
    fontWeight: 500,
